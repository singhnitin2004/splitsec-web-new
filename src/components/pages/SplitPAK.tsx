...
export default function SplitPAK() {
    ...
    return (
        <div className="w-full min-h-screen">
            ...
            <section className="w-full py-10 sm:py-14 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-28 bg-white">
                <div className="w-full max-w-[1800px] mx-auto ">
            ...
            {/* Section 3: Request splitPAK - Black background, 3-step form */}
            <section
                id="request-split-pak"
                className="w-full py-12 sm:py-16 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-28 bg-[#0f1115]"
            >
                <div className="w-full max-w-[1800px] mx-auto">
